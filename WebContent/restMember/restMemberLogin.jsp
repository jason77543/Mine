		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				...
				<form class="" action="<%=request.getContextPath()%>/restMember/restMemberController"  method="post">
					...
					<div>
						<a href="<%=request.getContextPath()%>/restMember/restMemberFindPsw.jsp" class="btn btn-link">忘記密碼</a> 
						
						<a href="<%=request.getContextPath()%>/restMember/restMemberList.jsp" class="btn btn-link">註冊</a>
					</div>
